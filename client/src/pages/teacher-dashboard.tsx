            ...
            <TabsContent value="marks" className="space-y-6">
              <Card className="border-green-200/50 bg-white/90 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardDescription>Enter and manage student marks for your subjects</CardDescription>
                  <div className="flex items-center space-x-4">
                    <div className="relative flex-1 max-w-sm">
                      <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400 w-4 h-4" />
                      <Input
                    ...
                    <select
                      ...
                      className="px-3 py-2 border border-green-200 rounded-md focus:border-green-400 focus:outline-none"
                    >
                  ...
                  {marksLoading ? (
                    <div className="text-center py-8">
                      <motion.div
                        ...
                        className="w-8 h-8 border-2 border-green-600 border-t-transparent rounded-full mx-auto"
                      />
                      <p className="text-slate-600 mt-2">Loading marks...</p>
                    </div>
                  ) : (
                    <Table>
                      <TableHeader>
                        ...
                        {filteredMarks.map((mark, index) => (
                          ...
                          >
                            ...
                            <TableCell>
                              <Badge
                                variant={
                                  (mark.marks_obtained / mark.max_marks) * 100 >= 60
                                    ? "default"
                                    : "destructive"
                                }
                                className={
                              ...
                              {editingMark === mark.id ? (
                                <div className="flex space-x-2">
                                  <motion.div whileHover={{ scale: 1.05 }}>
                                    <Button
                                      ...
                                      disabled={updateMarkMutation.isPending}
                                ...
                                <motion.div whileHover={{ scale: 1.05 }}>
                                  <Button
                                    variant="ghost"
                                    size="sm"
                                    onClick={() => handleEditMark(mark.id, mark.marks_obtained)}
                                    className="text-green-600 hover:text-green-700 hover:bg-green-50"
                                  >
